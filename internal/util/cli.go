...
func LoadFlags() {
	...
	flag.IntVar(&Presilence, "presilence", 0, "Play this milliseconds of silence before the actual audio — might be helpful for audio devices that wake up not immediately")
